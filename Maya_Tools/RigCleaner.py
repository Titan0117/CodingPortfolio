...
'''
RIG CLEAN-UP TOOL
Description: Add this code to your toolbar for an easy click and go rig cleaning tool. 
This code will import your references, clean up your rig's namespace, and delete your controllers.
Date: 10/22/2022
Author: Miranda Koulogeorge
'''
...
def deleteRig(*args):
    ...
    # Note: This deletes the rigs conrollers, not the bones
